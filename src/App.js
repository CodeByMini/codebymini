    ...
    <div className="flex flex-col text-white bg-[#282c34] border-orange-600 border-2 ">
      <SectionRow>
        <div className="flex flex-col items-end justify-center">
          <p className="text-6xl">Daniel Johansson</p>
        ...
        <div>
          <img
            ...
            alt="logo"
            className="grayscale h-lvh opacity-30 min-w-full object-scale-down"
          />
        </div>
      </SectionRow>
      <SectionCol background={'images/background.png'}>
        <div className="flex flex-row p-8 h-[40vh]">
          <Card
          ...
          <Card
            ...
            date="2016-2020"
            tooltip={
              'Worked with sales and technical support for a light equipment rental company.'
            }
          />
          <Card
            title="LightsByMini"
            ...
            date="2006-2016"
            tooltip={
              'Worked with lighting design and as a lighting technician for various shows and events.'
            }
          />
        </div>
      </SectionCol>
